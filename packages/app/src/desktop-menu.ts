...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    items: [
      {
        type: "item",
        label: "NovelX Showcase",
        labelZh: "NovelX 展示",
        href: "https://ccbili30-collab.github.io/open-novelx/",
      },
      {
        type: "item",
        label: "NovelX Repository",
        labelZh: "NovelX 仓库",
        href: "https://github.com/ccbili30-collab/open-novelx",
      },
      { type: "item", label: "Export Logs...", labelZh: "导出日志...", command: "logs.export" },
      { type: "separator" },
      {
        ...
        labelZh: "分享反馈",
        href: "https://github.com/ccbili30-collab/open-novelx/issues/new",
      },
      {
        type: "item",
        label: "Report a Bug",
