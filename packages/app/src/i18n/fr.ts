export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par NovelX",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans NovelX.",
  ...
  "dialog.server.description": "Changez le serveur NovelX auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'NovelX dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'NovelX dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour NovelX dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez NovelX dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'NovelX puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "NovelX n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez NovelX.",
  ...
  "toast.update.description":
    "Une nouvelle version d'NovelX ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe NovelX",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'NovelX ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "NovelX inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur NovelX dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour NovelX",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'NovelX sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si NovelX suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'NovelX.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'NovelX",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'NovelX.",
