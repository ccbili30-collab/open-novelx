export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo NovelX",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no NovelX.",
  ...
  "dialog.server.description": "Trocar para qual servidor NovelX este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o NovelX em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o NovelX em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o NovelX em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o NovelX",
  "wsl.onboarding.opencodeReadyIn": "O NovelX está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O NovelX está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o NovelX em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o NovelX possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O NovelX não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o NovelX novamente.",
  ...
  "toast.update.description": "Uma nova versão do NovelX ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do NovelX",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: NovelX ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "NovelX inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor NovelX dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do NovelX",
  ...
  "settings.general.row.appearance.description": "Personalize como o NovelX aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o NovelX segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o NovelX é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o NovelX iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do NovelX.",
