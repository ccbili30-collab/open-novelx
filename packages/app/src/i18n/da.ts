export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af NovelX",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i NovelX.",
  ...
  "dialog.server.description": "Skift hvilken NovelX-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker NovelX i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer NovelX i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater NovelX i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før NovelX kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "NovelX kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter NovelX igen.",
  ...
  "toast.update.description": "En ny version af NovelX ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til NovelX-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, NovelX understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "NovelX inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør NovelX-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for NovelX",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan NovelX ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om NovelX følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan NovelX er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når NovelX starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af NovelX.",
