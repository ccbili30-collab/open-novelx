export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez NovelX",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w NovelX.",
  ...
  "dialog.server.description": "Przełącz serwer NovelX, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie NovelX w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie NovelX w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj NovelX w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj NovelX w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim NovelX będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "NovelX nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz NovelX.",
  ...
  "toast.update.description": "Nowa wersja NovelX ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu NovelX",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: NovelX nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "NovelX zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer NovelX wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla NovelX",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd NovelX na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy NovelX ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw NovelX.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania NovelX",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji NovelX.",
