export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من NovelX",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك NovelX Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في NovelX.",
  ...
  "dialog.server.description": "تبديل خادم NovelX الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من NovelX في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث NovelX في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث NovelX في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت NovelX في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن NovelX من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على NovelX التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح NovelX.",
  ...
  "toast.update.description": "نسخة جديدة من NovelX ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق NovelX",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن NovelX لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن NovelX نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم NovelX داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ NovelX",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور NovelX على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان NovelX يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة NovelX.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل NovelX",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من NovelX.",
