...
export const dict = {
  ...
  "novelx.resources.graph": "圖譜",
  "novelx.resources.story": "故事",
  "novelx.resources.package": "世界包",
  "novelx.titlebar.home": "返回目前專案首頁",
  "novelx.titlebar.leftToggle": "展開或收起專案與工作階段",
  "novelx.titlebar.rightToggle": "展開或收起專案資源",
  "novelx.resourceDock.label": "專案資源",
  "novelx.resource.details": "詳細資訊",
  "novelx.resource.path": "路徑",
  "novelx.resource.state": "狀態",
  "novelx.resource.realFile": "真實專案檔案",
  "novelx.resource.openedInEditor": "這個真實專案檔案已在現有編輯器中開啟。",
  "novelx.document.mode.label": "文件編輯模式",
  "novelx.document.mode.visual": "排版",
  "novelx.document.mode.source": "原始碼",
  "novelx.document.save": "儲存",
  "novelx.document.reload": "重新載入",
  "novelx.document.discardReload": "放棄修改並重新載入",
  "novelx.document.status.loading": "正在載入",
  "novelx.document.status.saved": "已儲存",
  "novelx.document.status.dirty": "有未儲存修改",
  "novelx.document.status.saving": "正在儲存",
  "novelx.document.status.conflict": "儲存衝突",
  "novelx.document.status.error": "發生錯誤",
  "novelx.document.agent": "Agent",
  "novelx.document.locked": "{{agent}} 正在編輯這個檔案；該操作停止前，此處唯讀。",
  "novelx.document.externalChanged": "檔案已在編輯器外發生變化；你的草稿沒有被覆蓋。",
  "novelx.document.sourceOnly": "為了完整保留{{reason}}語法，此檔案必須使用原始碼模式。",
  "novelx.document.unsupported.raw-html": "原始 HTML",
  "novelx.document.unsupported.table": "表格",
  "novelx.document.unsupported.task-list": "工作清單",
  "novelx.document.unsupported.footnote": "註腳",
  "novelx.document.unsupported.math": "數學公式",
  "novelx.document.unsupported.directive": "擴充指令",
  "novelx.document.altHint": "按住 Alt 暫時查看原始碼",
  "novelx.document.unsaved.title": "目前文件還有未儲存修改",
  "novelx.document.unsaved.description": "請先儲存，或放棄修改並重新載入，再開啟其他檔案。",
  "novelx.resource.openDetails": "展開詳細資訊",
  "novelx.conversation.expand": "展開對話",
  "novelx.conversation.collapse": "收起對話",
  "novelx.resource.noStructuredData": "這個工作面目前還沒有可用的真實結構化資料。",
  "novelx.resource.files.summary": "真實專案檔案與文件編輯",
  "novelx.resource.files.emptyTitle": "選擇一個專案檔案",
  "novelx.resource.files.emptyDescription": "從導覽器選擇檔案，直接在這裡編輯。",
  "novelx.resource.world.summary": "世界結構、地理、文明與歷史",
  "novelx.resource.world.emptyTitle": "尚未選擇 Atlas 場景",
  "novelx.resource.world.emptyDescription": "World 檔案樹是真實資料；結構化 Atlas 運行鏈尚未接入。",
  "novelx.resource.characters.summary": "以文字為主的角色檔案",
  "novelx.resource.characters.emptyTitle": "尚未選擇角色",
  "novelx.resource.characters.emptyDescription": "請選擇真實角色文件；結構化角色檔案尚未接入。",
  "novelx.resource.graph.summary": "世界事實、關係與因果查詢",
  "novelx.resource.graph.emptyTitle": "還沒有圖譜投影",
  "novelx.resource.graph.emptyDescription": "接入真實圖譜投影前，這裡不會產生裝飾性假節點。",
  "novelx.resource.story.summary": "卷、章、場景與事件鏈",
  "novelx.resource.story.emptyTitle": "尚未選擇故事",
  "novelx.resource.story.emptyDescription": "請選擇真實故事文件；結構化故事物件尚未接入。",
  "novelx.resource.package.summary": "封面、總覽、校驗與打包",
  "novelx.resource.package.emptyTitle": "還沒有世界包中繼資料",
  "novelx.resource.package.emptyDescription": "接入真實世界包運行鏈前，打包與校驗不可用。",
  "novelx.resources.fileContents": "檔案內容",
  "novelx.resources.activity": "活動與產物",
  "novelx.resources.discuss": "交流",
  "novelx.resources.viewAll": "查看全部",
  "novelx.workspace.tagline": "世界、故事與原創角色的創作工作台",
  "novelx.prompt.placeholder": "和大管家討論、檢索或修改目前專案",
  "novelx.world.empty": "No World files yet",
  "novelx.world.error": "World files could not be loaded",
  "novelx.toolbar.label": "NovelX 工作區控制",
  "novelx.toolbar.modes": "工作區模式",
  "novelx.toolbar.player": "玩家模式",
  "novelx.toolbar.playerUnavailable": "玩家模式尚未接入目前運行鏈",
  "novelx.toolbar.companion": "Agent 模式",
  "novelx.toolbar.ide": "IDE 模式",
  "novelx.toolbar.import": "匯入",
  "novelx.toolbar.settings": "設定",
  "novelx.sidebar.projects": "專案",
  "novelx.sidebar.projectActions": "專案操作",
  "novelx.sidebar.openProject": "開啟專案",
  "novelx.sidebar.shortcuts": "置頂捷徑",
  "novelx.sidebar.pin": "置頂捷徑",
  "novelx.sidebar.unpin": "取消置頂",
  "novelx.status.project": "專案：{{project}}",
  "novelx.status.agent": "Agent：{{agent}}",
  "novelx.composer.modes": "對話模式",
  "novelx.composer.assist": "協助",
  "novelx.composer.free": "自由",
  "novelx.composer.freeUnavailable": "自由模式尚未接入目前運行鏈",
  ...
  "dialog.model.unpaid.freeModels.title": "NovelX 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 NovelX 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NovelX Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 NovelX 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 NovelX 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 NovelX 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 NovelX...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NovelX 已就緒。",
  "wsl.onboarding.opencodeReady": "NovelX 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 NovelX。",
  "wsl.onboarding.installOpencode": "安裝 NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 NovelX",
  ...
  "wsl.onboarding.wslUnavailable.description": "NovelX 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 NovelX。",
  ...
  "toast.update.description": "NovelX 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 NovelX 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: NovelX 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "NovelX 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 NovelX 伺服器。",
  ...
  "settings.general.row.language.description": "變更 NovelX 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 NovelX 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 NovelX 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 NovelX 的主題。",
  ...
  "settings.updates.row.startup.description": "在 NovelX 啟動時自動檢查更新",
