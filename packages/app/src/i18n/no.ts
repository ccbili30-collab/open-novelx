...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av NovelX",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i NovelX.",
  ...
  "dialog.server.description": "Bytt hvilken NovelX-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av NovelX ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til NovelX-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at NovelX ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "NovelX inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør NovelX-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for NovelX",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan NovelX ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om NovelX skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan NovelX er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når NovelX starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av NovelX.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker NovelX i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer NovelX i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater NovelX i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer NovelX i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før NovelX kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "NovelX kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter NovelX på nytt.",
