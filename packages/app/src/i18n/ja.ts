export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "NovelXが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、NovelXで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してNovelXで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、NovelXで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するNovelXサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "NovelXを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のNovelXを確認中...",
  "wsl.onboarding.updatingOpencode": "NovelXを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のNovelXを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のNovelXを更新してください。",
  "wsl.onboarding.updateOpencode": "NovelXを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のNovelXの準備ができました。",
  "wsl.onboarding.opencodeReady": "NovelXの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にNovelXをインストールしてください。",
  "wsl.onboarding.installOpencode": "NovelXをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelXがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "NovelXでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、NovelXをもう一度開いてください。",
  ...
  "toast.update.description": "NovelXの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをNovelXチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: NovelXはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "NovelXには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でNovelXサーバーを実行します。",
  ...
  "settings.general.row.language.description": "NovelXの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのNovelXの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "NovelXがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "NovelXのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "NovelX の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "NovelX は最新バージョンです。",
