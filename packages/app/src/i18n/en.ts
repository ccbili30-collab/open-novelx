export const dict = {
  ...
  "novelx.resources.characters": "Characters",
  "novelx.resources.graph": "Graph",
  "novelx.resources.story": "Story",
  "novelx.resources.package": "World package",
  "novelx.titlebar.home": "Return to the current project home",
  "novelx.titlebar.leftToggle": "Toggle projects and sessions",
  "novelx.titlebar.rightToggle": "Toggle project resources",
  "novelx.resourceDock.label": "Project resources",
  "novelx.resource.details": "Details",
  "novelx.resource.path": "Path",
  "novelx.resource.state": "State",
  "novelx.resource.realFile": "Real project file",
  "novelx.resource.openedInEditor": "This real project file has been opened in the existing editor.",
  "novelx.document.mode.label": "Document editing mode",
  "novelx.document.mode.visual": "Visual",
  "novelx.document.mode.source": "Source",
  "novelx.document.save": "Save",
  "novelx.document.reload": "Reload",
  "novelx.document.discardReload": "Discard and reload",
  "novelx.document.status.loading": "Loading",
  "novelx.document.status.saved": "Saved",
  "novelx.document.status.dirty": "Unsaved changes",
  "novelx.document.status.saving": "Saving",
  "novelx.document.status.conflict": "Save conflict",
  "novelx.document.status.error": "Error",
  "novelx.document.agent": "Agent",
  "novelx.document.locked": "{{agent}} is editing this file. It is read-only until that operation stops.",
  "novelx.document.externalChanged": "The file changed outside this editor. Your draft has not been overwritten.",
  "novelx.document.sourceOnly": "Source mode is required to preserve {{reason}} syntax.",
  "novelx.document.unsupported.raw-html": "raw HTML",
  "novelx.document.unsupported.table": "table",
  "novelx.document.unsupported.task-list": "task-list",
  "novelx.document.unsupported.footnote": "footnote",
  "novelx.document.unsupported.math": "math",
  "novelx.document.unsupported.directive": "directive",
  "novelx.document.altHint": "Hold Alt to inspect source",
  "novelx.document.unsaved.title": "This document has unsaved changes",
  "novelx.document.unsaved.description": "Save it or discard and reload before opening another file.",
  "novelx.resource.openDetails": "Open details",
  "novelx.conversation.expand": "Expand conversation",
  "novelx.conversation.collapse": "Collapse conversation",
  "novelx.resource.noStructuredData": "No real structured data is available for this view yet.",
  "novelx.resource.files.summary": "Real project files and document editing",
  "novelx.resource.files.emptyTitle": "Select a project file",
  "novelx.resource.files.emptyDescription": "Choose a file from the navigator to edit it here.",
  "novelx.resource.world.summary": "World structure, geography, civilizations, and history",
  "novelx.resource.world.emptyTitle": "No Atlas scene selected",
  "novelx.resource.world.emptyDescription":
    "The World tree is real; the structured Atlas runtime is not connected yet.",
  "novelx.resource.characters.summary": "Text-first character dossiers",
  "novelx.resource.characters.emptyTitle": "No character selected",
  "novelx.resource.characters.emptyDescription":
    "Select a real character document. Structured character dossiers are not connected yet.",
  "novelx.resource.graph.summary": "World facts, relations, and causal queries",
  "novelx.resource.graph.emptyTitle": "No graph projection available",
  "novelx.resource.graph.emptyDescription": "This view will remain empty until a real graph projection is connected.",
  "novelx.resource.story.summary": "Volumes, chapters, scenes, and event chains",
  "novelx.resource.story.emptyTitle": "No story selected",
  "novelx.resource.story.emptyDescription":
    "Select a real story document. Structured story objects are not connected yet.",
  "novelx.resource.package.summary": "Cover, overview, validation, and packaging",
  "novelx.resource.package.emptyTitle": "No world package metadata available",
  "novelx.resource.package.emptyDescription":
    "Packaging and validation remain unavailable until the real world-package runtime is connected.",
  "novelx.resources.fileContents": "File contents",
  "novelx.resources.activity": "Activity & artifacts",
  "novelx.resources.discuss": "Discuss",
  "novelx.resources.viewAll": "View all",
  ...
  "novelx.toolbar.label": "NovelX workspace controls",
  "novelx.toolbar.modes": "Workspace modes",
  "novelx.toolbar.player": "Player mode",
  "novelx.toolbar.playerUnavailable": "Player mode is not connected to the current runtime",
  "novelx.toolbar.companion": "Agent mode",
  "novelx.toolbar.ide": "IDE mode",
  "novelx.toolbar.import": "Import",
  "novelx.toolbar.settings": "Settings",
  "novelx.sidebar.projects": "Projects",
  "novelx.sidebar.projectActions": "Project actions",
  "novelx.sidebar.openProject": "Open project",
  "novelx.sidebar.shortcuts": "Pinned shortcuts",
  "novelx.sidebar.pin": "Pin shortcut",
  "novelx.sidebar.unpin": "Unpin shortcut",
  "novelx.project.create.name": "Project name",
  "novelx.project.rename.action": "Rename",
  "novelx.project.rename.title": "Rename project",
  "novelx.study.restore.failed": "Failed to restore Study projects",
  "novelx.project.create.placeholder": "For example: Mountains and Rivers",
  "novelx.project.create.hint": "Choose a location next. NovelX will create a separate project folder there.",
  "novelx.project.create.locationTitle": "Choose where to create the NovelX project",
  "novelx.project.create.action": "Choose location and create",
  "novelx.project.create.creating": "Creating…",
  "novelx.project.create.retryOpen": "Retry opening",
  "novelx.project.create.invalidName": "Use a valid folder name without reserved characters or names.",
  "novelx.project.create.gitUnavailable": "Creating an independent project requires Git. Install Git and try again.",
  "novelx.project.create.conflict":
    "A file or folder with this name already exists there. Rename it or open the existing project.",
  "novelx.project.create.unavailable": "New local projects are not available for the current connection.",
  "novelx.project.create.failed": "Could not create the project folder: {{error}}",
  "novelx.project.create.openFailed":
    "The folder was created at {{directory}}, but NovelX could not open it: {{error}}",
  "novelx.status.project": "Project: {{project}}",
  "novelx.status.agent": "Agent: {{agent}}",
  "novelx.composer.modes": "Conversation modes",
  "novelx.composer.assist": "Assist",
  "novelx.composer.free": "Free",
  "novelx.composer.freeUnavailable": "Free mode is not connected to the current runtime",
  "novelx.growth.running": "Growing: {{title}}",
  "novelx.growth.retry": "Network retry {{attempt}}/5 · continuing in {{seconds}}s",
  "novelx.growth.stop": "Stop Growth",
  "novelx.liveGrowth.heading": "Growing",
  "novelx.liveGrowth.planned": "Waiting for plan",
  "novelx.liveGrowth.registering": "Editor registering",
  "novelx.liveGrowth.writing": "Filling stage",
  "novelx.liveGrowth.completed": "Stage complete",
  "novelx.liveGrowth.failed": "Generation failed",
  "novelx.liveGrowth.registered": "Waiting for assignment",
  "novelx.liveGrowth.leased": "Assigned",
  "novelx.liveGrowth.drafting": "Writing",
  "novelx.liveGrowth.reviewing": "Editor reviewing",
  "novelx.liveGrowth.committed": "Committed",
  "novelx.liveGrowth.readonly": "Live draft · read-only",
  "novelx.liveGrowth.waiting": "Waiting for streamed text",
  "novelx.liveGrowth.resumeFollow": "Follow current growth",
  "novelx.liveGrowth.latest": "Jump to latest",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by NovelX",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in NovelX.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "NovelX Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "NovelX",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in NovelX.",
  ...
  "dialog.server.description": "Switch which NovelX server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "NovelX",
  ...
  "wsl.onboarding.checkingOpencode": "Checking NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Checking NovelX in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Updating NovelX in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update NovelX in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX is ready.",
  "wsl.onboarding.installOpencodeIn": "Install NovelX in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before NovelX can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "NovelX could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen NovelX.",
  ...
  "toast.update.description": "A new version of NovelX ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the NovelX team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, NovelX does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "NovelX includes free models so you can start immediately.",
  ...
  "app.name.desktop": "NovelX Desktop",
  ...
  "settings.desktop.wsl.description": "Run the NovelX server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for NovelX",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how NovelX looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether NovelX follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how NovelX is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when NovelX launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of NovelX.",
