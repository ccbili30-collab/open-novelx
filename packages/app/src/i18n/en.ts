export const dict = {
  ...
  "novelx.project.create.conflict": "A file or folder with this name already exists there. Rename it or open the existing project.",
  ...
  "novelx.project.create.openFailed": "The folder was created at {{directory}}, but NovelX could not open it: {{error}}",
