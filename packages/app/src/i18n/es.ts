export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por NovelX",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en NovelX.",
  ...
  "provider.connect.opencodeZen.line1":
    "NovelX Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en NovelX.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en NovelX.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de NovelX se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando NovelX en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando NovelX en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza NovelX en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar NovelX",
  "wsl.onboarding.opencodeReadyIn": "NovelX está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "NovelX está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala NovelX en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "NovelX no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que NovelX pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "NovelX no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir NovelX.",
  ...
  "toast.update.description": "Una nueva versión de NovelX ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de NovelX",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, NovelX no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "NovelX incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor NovelX dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para NovelX",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve NovelX en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si NovelX sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de NovelX.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia NovelX",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de NovelX.",
