...
export const dict = {
  ...
  "novelx.resources.characters": "角色",
  "novelx.resources.graph": "图谱",
  "novelx.resources.story": "故事",
  "novelx.resources.package": "世界包",
  "novelx.titlebar.home": "返回当前项目主页",
  "novelx.titlebar.leftToggle": "展开或收起项目与会话",
  "novelx.titlebar.rightToggle": "展开或收起项目资源",
  "novelx.resourceDock.label": "项目资源",
  "novelx.resource.details": "详细信息",
  "novelx.resource.path": "路径",
  "novelx.resource.state": "状态",
  "novelx.resource.realFile": "真实项目文件",
  "novelx.resource.openedInEditor": "这个真实项目文件已经在现有编辑器中打开。",
  "novelx.document.mode.label": "文档编辑模式",
  "novelx.document.mode.visual": "排版",
  "novelx.document.mode.source": "源码",
  "novelx.document.save": "保存",
  "novelx.document.reload": "重新载入",
  "novelx.document.discardReload": "放弃修改并重新载入",
  "novelx.document.status.loading": "正在载入",
  "novelx.document.status.saved": "已保存",
  "novelx.document.status.dirty": "有未保存修改",
  "novelx.document.status.saving": "正在保存",
  "novelx.document.status.conflict": "保存冲突",
  "novelx.document.status.error": "发生错误",
  "novelx.document.agent": "Agent",
  "novelx.document.locked": "{{agent}} 正在编辑这个文件；该操作停止前，此处只读。",
  "novelx.document.externalChanged": "文件已在编辑器外发生变化；你的草稿没有被覆盖。",
  "novelx.document.sourceOnly": "为了完整保留{{reason}}语法，此文件必须使用源码模式。",
  "novelx.document.unsupported.raw-html": "原始 HTML",
  "novelx.document.unsupported.table": "表格",
  "novelx.document.unsupported.task-list": "任务列表",
  "novelx.document.unsupported.footnote": "脚注",
  "novelx.document.unsupported.math": "数学公式",
  "novelx.document.unsupported.directive": "扩展指令",
  "novelx.document.altHint": "按住 Alt 临时查看源码",
  "novelx.document.unsaved.title": "当前文档还有未保存修改",
  "novelx.document.unsaved.description": "请先保存，或放弃修改并重新载入，再打开其他文件。",
  "novelx.resource.openDetails": "展开详细信息",
  "novelx.conversation.expand": "展开对话",
  "novelx.conversation.collapse": "收起对话",
  "novelx.resource.noStructuredData": "这个工作面目前还没有可用的真实结构化数据。",
  "novelx.resource.files.summary": "真实项目文件与文档编辑",
  "novelx.resource.files.emptyTitle": "选择一个项目文件",
  "novelx.resource.files.emptyDescription": "从导航器选择文件，直接在这里编辑。",
  "novelx.resource.world.summary": "世界结构、地理、文明与历史",
  "novelx.resource.world.emptyTitle": "尚未选择 Atlas 场景",
  "novelx.resource.world.emptyDescription": "World 文件树是真实数据；结构化 Atlas 运行链尚未接入。",
  "novelx.resource.characters.summary": "以文字为主的角色档案",
  "novelx.resource.characters.emptyTitle": "尚未选择角色",
  "novelx.resource.characters.emptyDescription": "请选择真实角色文档；结构化角色档案尚未接入。",
  "novelx.resource.graph.summary": "世界事实、关系与因果查询",
  "novelx.resource.graph.emptyTitle": "还没有图谱投影",
  "novelx.resource.graph.emptyDescription": "接入真实图谱投影前，这里不会生成装饰性假节点。",
  "novelx.resource.story.summary": "卷、章、场景与事件链",
  "novelx.resource.story.emptyTitle": "尚未选择故事",
  "novelx.resource.story.emptyDescription": "请选择真实故事文档；结构化故事对象尚未接入。",
  "novelx.resource.package.summary": "封面、总览、校验与打包",
  "novelx.resource.package.emptyTitle": "还没有世界包元数据",
  "novelx.resource.package.emptyDescription": "接入真实世界包运行链前，打包与校验不可用。",
  "novelx.resources.fileContents": "文件内容",
  "novelx.resources.activity": "活动与产物",
  "novelx.resources.discuss": "交流",
  "novelx.resources.viewAll": "查看全部",
  "novelx.world.empty": "世界目录中还没有文件",
  "novelx.world.error": "无法加载世界文件",
  "novelx.workspace.tagline": "世界、故事与原创角色的创作工作台",
  "novelx.prompt.placeholder": "和大管家讨论，检索或修改当前项目",
  "novelx.toolbar.label": "NovelX 工作区控制",
  "novelx.toolbar.modes": "工作区模式",
  "novelx.toolbar.player": "玩家模式",
  "novelx.toolbar.playerUnavailable": "玩家模式尚未接入当前运行链",
  "novelx.toolbar.companion": "Agent 模式",
  "novelx.toolbar.ide": "IDE 模式",
  "novelx.toolbar.import": "导入",
  "novelx.toolbar.settings": "设置",
  "novelx.sidebar.projects": "项目",
  "novelx.sidebar.projectActions": "项目操作",
  "novelx.sidebar.openProject": "打开项目",
  "novelx.sidebar.shortcuts": "置顶快捷方式",
  "novelx.sidebar.pin": "置顶快捷方式",
  "novelx.sidebar.unpin": "取消置顶",
  "novelx.project.create.name": "项目名称",
  "novelx.project.rename.action": "重命名",
  "novelx.project.rename.title": "重命名项目",
  "novelx.study.restore.failed": "Study 项目恢复失败",
  "novelx.project.create.placeholder": "例如：群山与河谷",
  "novelx.project.create.hint": "下一步选择保存位置，NovelX 会在那里创建独立的项目文件夹。",
  "novelx.project.create.locationTitle": "选择 NovelX 项目的保存位置",
  "novelx.project.create.action": "选择位置并创建",
  "novelx.project.create.creating": "正在创建…",
  "novelx.project.create.retryOpen": "重试打开",
  "novelx.project.create.invalidName": "请输入有效的文件夹名称，不能使用系统保留字符或名称。",
  "novelx.project.create.gitUnavailable": "新建独立项目需要本机 Git。请安装 Git 后重试。",
  "novelx.project.create.conflict": "该位置已有同名文件或文件夹。请修改名称，或打开已有项目。",
  "novelx.project.create.unavailable": "当前连接不支持新建本机项目。",
  "novelx.project.create.failed": "无法创建项目文件夹：{{error}}",
  "novelx.project.create.openFailed": "文件夹已创建在 {{directory}}，但 NovelX 未能打开它：{{error}}",
  "novelx.status.project": "项目：{{project}}",
  "novelx.status.agent": "Agent：{{agent}}",
  "novelx.composer.modes": "对话模式",
  "novelx.composer.assist": "协助",
  "novelx.composer.free": "自由",
  "novelx.composer.freeUnavailable": "自由模式尚未接入当前运行链",
  "novelx.growth.running": "正在生长：{{title}}",
  "novelx.growth.retry": "网络重试 {{attempt}}/5 · {{seconds}} 秒后继续",
  "novelx.growth.stop": "停止生长",
  "novelx.liveGrowth.heading": "生长中",
  "novelx.liveGrowth.planned": "等待规划",
  "novelx.liveGrowth.registering": "主编注册中",
  "novelx.liveGrowth.writing": "正在填充",
  "novelx.liveGrowth.completed": "本阶段已完成",
  "novelx.liveGrowth.failed": "生成失败",
  "novelx.liveGrowth.registered": "等待分配",
  "novelx.liveGrowth.leased": "已分配",
  "novelx.liveGrowth.drafting": "正在写作",
  "novelx.liveGrowth.reviewing": "主编审核中",
  "novelx.liveGrowth.committed": "已提交",
  "novelx.liveGrowth.readonly": "实时草稿 · 只读",
  "novelx.liveGrowth.waiting": "等待正文流式输出",
  "novelx.liveGrowth.resumeFollow": "跟随正在生长",
  "novelx.liveGrowth.latest": "回到最新内容",
  ...
  "command.prompt.mode.shell": "命令行",
  "command.prompt.mode.normal": "对话",
  ...
  "dialog.provider.opencode.note": "使用 NovelX Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "NovelX 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 NovelX 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "NovelX Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 NovelX 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 NovelX 中使用 {{provider}} 模型。",
  ...
  "prompt.mode.shell": "命令行",
  "prompt.mode.normal": "对话",
  ...
  "dialog.server.description": "切换此应用连接的 NovelX 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 NovelX...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 NovelX...",
  "wsl.onboarding.updatingOpencode": "正在更新 NovelX...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 NovelX...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 NovelX。",
  "wsl.onboarding.updateOpencode": "更新 NovelX",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 NovelX 已就绪。",
  "wsl.onboarding.opencodeReady": "NovelX 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 NovelX。",
  "wsl.onboarding.installOpencode": "安装 NovelX",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 NovelX",
  ...
  "wsl.onboarding.wslNotInstalled.description": "NovelX 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "NovelX 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 NovelX。",
  ...
  "toast.update.description": "NovelX 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 NovelX 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: NovelX 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "NovelX 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 NovelX 服务器。",
  ...
  "settings.general.row.language.description": "更改 NovelX 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 NovelX 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 NovelX 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 NovelX 的主题。",
  ...
  "settings.updates.row.startup.description": "在 NovelX 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 NovelX。",
