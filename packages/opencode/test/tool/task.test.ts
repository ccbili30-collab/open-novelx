...
describe("tool.task", () => {
  ...
  it.instance("allows only the built-in NovelX editorial chains, including the Story-owned visual tool branch", () =>
    Effect.gen(function* () {
      ...
      expect(story.output).toContain("This child handoff is not terminal")
      expect(story.output).toContain("novelx_route_growth")
      ...
      expect(character.output).toContain("This child handoff is not terminal")
      expect(character.output).toContain("novelx_route_growth")
