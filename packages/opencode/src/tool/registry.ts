...
import { NovelXRegisterWorldBlueprintTool } from "./novelx-register-world-blueprint"
import { NovelXPrepareWorldStageTool } from "./novelx-prepare-world-stage"
import { NovelXRegisterWorldStageTool } from "./novelx-register-world-stage"
import { NovelXPrepareWorldDocumentTool } from "./novelx-prepare-world-document"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const registerWorldBlueprint = yield* NovelXRegisterWorldBlueprintTool
    const prepareWorldStage = yield* NovelXPrepareWorldStageTool
    const registerWorldStage = yield* NovelXRegisterWorldStageTool
    const prepareWorldDocument = yield* NovelXPrepareWorldDocumentTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          registerWorldBlueprint: Tool.init(registerWorldBlueprint),
          prepareWorldStage: Tool.init(prepareWorldStage),
          registerWorldStage: Tool.init(registerWorldStage),
          prepareWorldDocument: Tool.init(prepareWorldDocument),
        ...
        return {
          ...
          builtin: [
            ...
            tool.registerWorldBlueprint,
            tool.prepareWorldStage,
            tool.registerWorldStage,
            tool.prepareWorldDocument,
