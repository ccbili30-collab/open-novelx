...
const api: ElectronAPI = {
  ...
  createProjectDirectory: (opts) => ipcRenderer.invoke("create-project-directory", opts),
  ...
  authorizeProjectDirectoryTrash: (path) => ipcRenderer.invoke("authorize-project-directory-trash", path),
  trashProjectDirectory: (authorization) => ipcRenderer.invoke("trash-project-directory", authorization),
