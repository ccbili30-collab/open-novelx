export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju NovelX-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} NovelX-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
