export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av NovelX",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av NovelX er lastet ned. Vil du installere den og starte på nytt?",
