export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de NovelX",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de NovelX. ¿Quieres instalarla y reiniciar?",
