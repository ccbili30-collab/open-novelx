export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af NovelX",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af NovelX er blevet downloadet. Vil du installere den og genstarte?",
