export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію NovelX",
  ...
  "desktop.updater.downloaded.prompt": "Версію {{version}} NovelX завантажено. Бажаєте встановити її та перезапустити?",
