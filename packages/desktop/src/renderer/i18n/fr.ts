export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'NovelX",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'NovelX a été téléchargée. Voulez-vous l'installer et redémarrer ?",
