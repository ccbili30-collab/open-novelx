export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von NovelX",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von NovelX wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
